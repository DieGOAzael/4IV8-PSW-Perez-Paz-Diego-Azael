    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<form name=\"datos_act\" method=\"get\" action=\"editarUsuario\" onsubmit=\"return validarDatosA(this)\">"
                    ...
                    + "<input type=\"text\" name=\"nombrea\" placeholder=\"Nuevo nombre: \" required>"
                    + "</div>"
                    + "<div class=\"input-box\">"
                    + "<span class=\"details\">Correo electrónico</span>"
                    + "<input type=\"email\" name=\"correoa\" placeholder=\"Nuevo correo: \" required>"
                    + "</div>"
                    + "<div class=\"input-box\">"
                    + "<span class=\"details\">Apellido paterno</span>"
                    + "<input type=\"text\" name=\"appata\" placeholder=\"Nuevo Apellido paterno: \" required>"
                    + "</div>"
                    + "<div class=\"input-box\">"
                    + "<span class=\"details\">Apellido materno</span>"
                    + "<input type=\"text\" name=\"apmata\" placeholder=\"Nuevo Apellido materno:\" required>"
                    + "</div>"
                    + "<div class=\"input-box\">"
                    + "<span class=\"details\">Edad</span>"
                    + "<input type=\"number\" name=\"edada\" placeholder=\"Nueva edad: \" required>"
                    + "</div>"
                    + "<div class=\"input-box\">"
                    + "<span class=\"details\">ID</span>"
                    + "<input type=\"number\" name=\"ida\" placeholder=\"Para confirmar el cambio digite el mismo ID\" required>"
                    + "</div>"
                    + "<div class=\"button\">"
